...
def get_audio_filepaths(manifest_entry: Dict[str, Any], audio_dir: Path, field_name: str = "audio_filepath") -> Tuple[Path, Path]:
    """
    ...
    """
    audio_filepath = Path(manifest_entry[field_name])
