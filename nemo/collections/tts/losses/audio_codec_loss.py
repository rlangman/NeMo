...
class MMDCodebookLoss(Loss):
    """
    MMD loss which rewards independence between codebooks within each timestep.
...
class MMDEmbeddingLoss(Loss):
    """
    MMD loss which rewards independence between embedding values within each timestep.
...
class MMDTimeLoss(Loss):
    """
    MMD loss which rewards independence between different timesteps.
